...
console.log(`Boiling temperatures for ${operationPressure}mmHg (Tmin) => `, boilingTemperature(feedComposition, operationPressure))
console.log("    --- Flow rate and compositions ---")
console.log("")
console.log(`Knowing temperature (${operationTemperature}ºC) and assuming feedFlowRate => `, flowRateDeterminationKnowingTemperature(feedComposition, operationTemperature))
...
function dewTemperature(feed, operationPressure) {
  ...
  for (var temperature = 0; temperature < 400; temperature = temperature + 0.01) {
    ...
    const sum = +(compoundsWithSteamPressures.reduce((accumulator, compound) => {
